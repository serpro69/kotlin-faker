...
* https://github.com/serpro69/kotlin-faker/pull/278[#278] (extension) Change artifact names of extension modules
...
* https://github.com/serpro69/kotlin-faker/issues/278[#278] (core) Refactor build configs to use kotlin multiplatform plugin
