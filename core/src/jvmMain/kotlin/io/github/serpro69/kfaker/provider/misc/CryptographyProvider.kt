...
class CryptographyProvider internal constructor(fakerService: FakerService) :
    ...
    override val unique: CryptographyProvider by
    ...
    private fun sha(len: Int): String =
        with(fakerService) { resolveUniqueValue("regexify") { """[a-f0-9]{$len}""".regexify() } }
}
