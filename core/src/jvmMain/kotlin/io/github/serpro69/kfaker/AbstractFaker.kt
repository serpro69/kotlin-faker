...
abstract class AbstractFaker(internal val config: FakerConfig) {
    ...
    abstract class Builder<T : AbstractFaker> {
        /**
         * @property config faker configuration for the [AbstractFaker] instance which will be
         *   created with this [AbstractFaker.Builder].
         */
        protected var config: FakerConfig = io.github.serpro69.kfaker.fakerConfig {}

        /**
         * Sets [config] configuration for this [AbstractFaker.Builder] using the results of the
         * [block] function.
         *
         * This [config] will then be used when an instance of [AbstractFaker] is created using this
         * [AbstractFaker.Builder]
         */
