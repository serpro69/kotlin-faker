    ...
    DescribeSpec({
        ...
        """
            ...
            context("generates a domain name") {
                ...
                internet.domain(subdomain = true) shouldMatch
                    Regex("""[a-z]+(-[a-z]+)?\.[a-z]+(-[a-z]+)?\.(example|test)""")
                ...
                internet
                    .domain(subdomain = true, domain = "kotlin-faker.test")
                    .substringAfter(".") shouldBe "kotlin-faker.test"
                internet.domain(subdomain = true, domain = "faker.kotlin-faker.test") shouldBe
                    "faker.kotlin-faker.test"
                // check domain normalization from Ukrainian lang
                ukFaker.internet.domain() shouldMatch Regex("""[a-z]+(-[a-z]+)?\.(example|test)""")
                ukFaker.internet.domain(subdomain = true) shouldMatch
                    Regex("""[a-z]+(-[a-z]+)?\.[a-z]+(-[a-z]+)?\.(example|test)""")
            }
