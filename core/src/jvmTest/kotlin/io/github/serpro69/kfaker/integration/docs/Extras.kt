    ...
    DescribeSpec({
        ...
        describe("Random instance of any class") {
            ...
            context("configurable constructor arg type generation") {
                ...
                context("collection element generation") {
                    it(
                        "should generate pre-configured collection elements for constructor params"
                    ) {
                    ...
                    it(
                        "should generate pre-configured map key/value pairs for constructor params"
                    ) {
                        fun randomKey() = "key"
            ...
            context("configurable number of constructor args") {
                ...
                it("should generate collections with configured size") {
                    ...
                    val foo = faker.randomClass.randomClassInstance<Foo> { collectionsSize = 6 }
                ...
                it("should generate a set of size 10") {
                    ...
                    class TestClass(val string: String, val set: Set<String>)

                    val testClass =
                        faker.randomClass.randomClassInstance<TestClass> {
        ...
        describe("Random Everything") {
            ...
            it("should generate random string of English chars") {
                ...
                faker.random.randomString(length = 42, numericalChars = false)
            ...
            it("should generate unique integers via local-unique-provider") {
                ...
                val ints = List(21) { faker.random.unique.nextInt(42) }
            ...
            it("should generate unique integers via global-unique-provider") {
                ...
                val uniqueInts = List(21) { faker.random.nextInt(42) }
