            ...
            context("randomValue<T>(list) fun") {
                ...
                context("list is empty") {
                    ...
                    it("exception is thrown") {
                        shouldThrow<IllegalArgumentException> { random.randomValue(values) }
                    }
                }
            ...
            context("nextEnum() fun") {
                ...
                repeat(10) {
                    it("should return a random enum entry based on a predicate #$it") {
                        val enum =
                            random.nextEnum(TestEnumRandom::class.java) { e ->
                        ...
                        val enums =
                            List(10) {
                                random.nextEnum<TestEnumRandom>(
                                    TestEnumRandom.ONE.name,
                                    TestEnumRandom.TWO.name,
                                )
                            }
            ...
            context("local unique provider") {
                ...
                repeat(10) {
                    it("should generate unique primitive values run#$it") {
                        val ints = List(21) { random.unique.nextInt(42) }
                    ...
                    it("should generate unique values from a list run#$it") {
                        ...
                        val ints = List(21) { random.unique.nextInt(42) }
                        // act
                        val randomInts = List(10) { random.unique.randomValue(ints) }
                        // assert
                    ...
                    it("should return unique enums run#$it") {
                        val enums = List(9) { random.unique.nextEnum<TestEnumRandom>() }
                    ...
                    it("shouldn return unique enums with predicate run#$it") {
                        val excluded =
                            listOf(TestEnumRandom.ONE, TestEnumRandom.TWO, TestEnumRandom.THREE)
                        val enums =
                            List(6) {
                                random.unique.nextEnum(TestEnumRandom::class.java) { e ->
                                    e !in excluded
                                }
                            }
                        ...
                        val enums =
                            List(6) {
                                random.unique.nextEnum<TestEnumRandom>(
                                    *excluded.map { e -> e.name }.toTypedArray()
                                )
                            }
                        enums.distinct().size shouldBe 6
                        enums shouldNotContainAnyOf excluded
                    ...
                    it("should return unique sublits run#$it") {
                        ...
                        val ints = List(21) { random.unique.nextInt(42) }
                        // act
                        val randomInts = List(10) { random.unique.randomSublist(ints, 6) }
                        // assert
            ...
            context("global unique provider") {
                ...
                repeat(10) {
                    ...
                    it("should generate unique values from a list run#$it") {
                        ...
                        val ints = List(21) { faker.random.nextInt(42) }
                        // act
                        val randomInts = List(10) { faker.random.randomValue(ints) }
                        // assert
                        ints shouldContainAll randomInts
                        randomInts should beUnique()
                        // cleanup
                        faker.unique.clear(faker::random)
                    }

                    it("should return unique enums run#$it") {
                        val enums = List(9) { faker.random.nextEnum<TestEnumRandom>() }
                        enums should beUnique()
                        faker.unique.clear(faker::random)
                    }
                    ...
                    it("shouldn return unique enums with predicate run#$it") {
                        ...
                        val enums =
                            List(6) {
                                faker.random.nextEnum(TestEnumRandom::class.java) { e ->
                                    e !in excluded
                                }
                            }
                        enums should beUnique()
                    ...
                    it("shouldn return unique enums excluding some names run#$it") {
                        ...
                        val enums =
                            List(6) {
                                faker.random.nextEnum<TestEnumRandom>(
                                    *excluded.map { e -> e.name }.toTypedArray()
                                )
                            }
                        enums should beUnique()
                    ...
                    it("should return unique sublits run#$it") {
                        ...
                        val ints = List(21) { faker.random.nextInt(42) }
                        // act
                        val randomInts = List(10) { faker.random.randomSublist(ints, 6) }
                        // assert
                        ints shouldContainAll randomInts.flatten()
                        randomInts should beUnique()
                        // cleanup
