...
@PublishedApi
internal val rcp = RandomClassProvider(fakerConfig { })
 ...
 * otherwise a constructor with minimal number of parameters will be used with randomly-generated values.
 *
 * @param fakerConfig configure the underlying [Faker]
 * @param configurator configure random class instance creation
 *
 * @throws NoSuchElementException if [T] has no public or internal constructor.
 */
inline fun <reified T : Any> randomClassInstance(
    fakerConfig: FakerConfig = fakerConfig { },
    configurator: RandomProviderConfig.() -> Unit = {}
): T = RandomClassProvider(fakerConfig).randomClassInstance<T>(configurator)
...
fun <T : Any> randomClassInstance(
    ...
    fakerConfig: FakerConfig = fakerConfig { },
    configurator: RandomProviderConfig.() -> Unit = {}
): T = RandomClassProvider(fakerConfig).randomClassInstance(kClass, configurator)
