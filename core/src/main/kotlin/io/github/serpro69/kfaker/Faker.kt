...
class Faker @JvmOverloads constructor(internal val config: FakerConfig = fakerConfig { }) {
    ...
    val adjective: Adjective = Adjective(fakerService)
    ...
    val australia: Australia = Australia(fakerService)
    ...
    val bible: Bible = Bible(fakerService)
    val bigBangTheory: BigBangTheory = BigBangTheory(fakerService)
    val bird: Bird = Bird(fakerService)
    ...
    val brooklynNineNine: BrooklynNineNine = BrooklynNineNine(fakerService)
    val buffy: Buffy = Buffy(fakerService)
    val business: Business = Business(fakerService)
    val camera: Camera = Camera(fakerService)
    ...
    val clashOfClans: ClashOfClans = ClashOfClans(fakerService)
    ...
    val conan: Conan = Conan(fakerService)
    ...
    val doraemon: Doraemon = Doraemon(fakerService)
    ...
    val emotion: Emotion = Emotion(fakerService)
    ...
    val finalSpace: FinalSpace = FinalSpace(fakerService)
    val finance: Finance = Finance(fakerService)
    val fmaBrotherhood: FmaBrotherhood = FmaBrotherhood(fakerService)
    ...
    val hobby: Hobby = Hobby(fakerService)
    ...
    val howToTrainYourDragon: HowToTrainYourDragon = HowToTrainYourDragon(fakerService)
    ...
    val jackHandey: JackHandey = JackHandey(fakerService)
    val job: Job = Job(fakerService)
    val kamenRider: KamenRider = KamenRider(fakerService)
    ...
    val mountain: Mountain = Mountain(fakerService)
    ...
    val naruto: Naruto = Naruto(fakerService)
    ...
    val room: Room = Room(fakerService)
    ...
    val studioGhibli: StudioGhibli = StudioGhibli(fakerService)
    val subscription: Subscription = Subscription(fakerService)
    val suits: Suits = Suits(fakerService)
    val superMario: SuperMario = SuperMario(fakerService)
    val superhero: Superhero = Superhero(fakerService)
    val supernatural: Supernatural = Supernatural(fakerService)
    ...
    val theKingkillerChronicle: TheKingkillerChronicle = TheKingkillerChronicle(fakerService)
    val theOffice: TheOffice = TheOffice(fakerService)
    val theThickOfIt: TheThickOfIt = TheThickOfIt(fakerService)
    val tolkien: Tolkien = Tolkien(fakerService)
    val touhou: Touhou = Touhou(fakerService)
    val tron: Tron = Tron(fakerService)
    ...
    val volleyball: Volleyball = Volleyball(fakerService)
