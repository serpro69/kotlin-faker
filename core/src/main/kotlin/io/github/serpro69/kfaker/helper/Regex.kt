 ...
 *
 * Borrowed from https://github.com/faker-ruby/faker/blob/b0ab11d93dd09c513a1009a28325ff6efdddf9a2/lib/faker/default/internet.rb#L349
 */
internal val reservedNets: List<Regex> = listOf(
 ...
 *
 * Borrowed from https://github.com/faker-ruby/faker/blob/b0ab11d93dd09c513a1009a28325ff6efdddf9a2/lib/faker/default/internet.rb#L317
 */
internal val privateNets: List<Regex> = listOf(
...
/**
 * Returns true if the [addr] contains at least one match in the [privateNets] regular expressions list.
 */
internal val isPrivateNet: (addr: (String)) -> Boolean = {
    privateNets.any(it::contains)
}

/**
 * Returns true if the [addr] contains at least one match in [privateNets] or [reservedNets] regular expressions lists.
 */
