...
class Money internal constructor(fakerService: FakerService) :
    AbstractFakeDataProvider<Money>(fakerService) {
    ...
    fun amount(
        ...
        return if (generateDecimals) {
            val randomDecimal =
                fakerService.randomService.nextInt(0..99).toString().let {
