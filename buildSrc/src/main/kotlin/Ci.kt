...
object Ci {
    ...
    /**
     * The base version used for the release version. For non release builds, `-SNAPSHOT` or
     * `-LOCAL` will be appended.
     */
    ...
    // false if we are publishing to a local directory for testing purposes or publishing the gradle
    // plugin
    val isRelease = releaseVersion != null

    val gradleRelease = System.getenv("GRADLE_RELEASE")?.ifBlank { null } ?: snapshotVersion

    /** The published version of kotlin-faker dependencies. */
