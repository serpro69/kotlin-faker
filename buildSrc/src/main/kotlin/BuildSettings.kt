...
/**
 * Common settings for configuring kotlin-faker build logic.
 *
 * The settings need to be accessible during configuration, so they should come from Gradle
 * properties or environment variables.
 */
abstract class BuildSettings @Inject constructor(private val providers: ProviderFactory) {

    /** Controls whether Kotlin Multiplatform JS is enabled */
    val enableKotlinJs: Provider<Boolean> = fakerFlag("enableKotlinJs", true)

    /** Controls whether Kotlin Multiplatform Native is enabled */
    val enableKotlinNative: Provider<Boolean> = fakerFlag("enableKotlinNative", false)
