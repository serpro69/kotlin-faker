 ...
 */
private fun Provider<JavaVersion>.isInstalled(javaToolchains: JavaToolchainService): Provider<Boolean> {
    ...
    return map { version ->
        runCatching {
            javaToolchains
                .launcherFor { languageVersion.set(JavaLanguageVersion.of(version.majorVersion)) }
                .orNull
        }.getOrNull() != null
    }
}
