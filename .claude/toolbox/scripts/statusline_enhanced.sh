...
load_theme() {
  ...
  darcula)
    case "${mode}" in
    light)
      blue='\033[38;2;0;51;179m'
      orange='\033[38;2;174;92;0m'
      green='\033[38;2;6;125;23m'
      cyan='\033[38;2;0;112;128m'
      red='\033[38;2;192;0;0m'
      yellow='\033[38;2;158;136;13m'
      white='\033[38;2;46;46;46m'
      magenta='\033[38;2;135;16;148m'
      ;;
    *)
      blue='\033[38;2;104;151;187m'
      orange='\033[38;2;204;120;50m'
      green='\033[38;2;106;135;89m'
      cyan='\033[38;2;41;153;153m'
      red='\033[38;2;188;63;60m'
      yellow='\033[38;2;187;181;41m'
      white='\033[38;2;169;183;198m'
      magenta='\033[38;2;152;118;170m'
      ;;
    esac
    ;;
  nord)
    ...
    light)
      ...
      green='\033[38;2;119;147;96m'
      cyan='\033[38;2;67;76;94m'
      red='\033[38;2;191;97;106m'
      yellow='\033[38;2;171;138;63m'
      white='\033[38;2;59;66;82m'
      magenta='\033[38;2;143;107;138m'
      ;;
    *)
...
line2="${magenta}${dim}${session_id}${reset}"
...
if $needs_refresh; then
  ...
  if [ -n "$token" ] && [ "$token" != "null" ]; then
    response=$(curl -s --max-time 5 \
      ...
      -H "User-Agent: claude-code/2.1.159" \
