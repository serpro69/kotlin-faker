...
class BirdOrderCommonMap internal constructor(
    ...
    override val secondaryCategory: Category,
    ...
    fun caprimulgiformes(): String = resolve(secondaryCategory, "order_common_map", "Caprimulgiformes")
    ...
    fun charadriiformes(): String = resolve(secondaryCategory, "order_common_map", "Charadriiformes")
    ...
    fun mesitornithiformes(): String = resolve(secondaryCategory, "order_common_map", "Mesitornithiformes")
    fun musophagiformes(): String = resolve(secondaryCategory, "order_common_map", "Musophagiformes")
    fun opisthocomiformes(): String = resolve(secondaryCategory, "order_common_map", "Opisthocomiformes")
    ...
    fun phaethontiformes(): String = resolve(secondaryCategory, "order_common_map", "Phaethontiformes")
    fun phoenicopteriformes(): String = resolve(secondaryCategory, "order_common_map", "Phoenicopteriformes")
    fun piciformes(): String = resolve(secondaryCategory, "order_common_map", "Piciformes")
    fun podicipediformes(): String = resolve(secondaryCategory, "order_common_map", "Podicipediformes")
    fun procellariiformes(): String = resolve(secondaryCategory, "order_common_map", "Procellariiformes")
    ...
    fun sphenisciformes(): String = resolve(secondaryCategory, "order_common_map", "Sphenisciformes")
    fun strigiformes(): String = resolve(secondaryCategory, "order_common_map", "Strigiformes")
    fun struthioniformes(): String = resolve(secondaryCategory, "order_common_map", "Struthioniformes")
