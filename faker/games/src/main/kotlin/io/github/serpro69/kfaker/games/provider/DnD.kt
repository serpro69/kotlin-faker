...
@Suppress("unused")
class DnD internal constructor(fakerService: FakerService) :
    YamlFakeDataProvider<DnD>(fakerService) {
...
/** [FakeDataProvider] implementation for [YamlCategory.DND] category. */
class DndName internal constructor(fakerService: FakerService) :
    YamlFakeDataProvider<DndName>(fakerService) {
    override val yamlCategory = YamlCategory.DND
