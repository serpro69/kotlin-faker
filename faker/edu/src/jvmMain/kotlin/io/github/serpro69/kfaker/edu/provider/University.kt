...
@Suppress("unused")
class University internal constructor(fakerService: FakerService) :
    YamlFakeDataProvider<University>(fakerService) {
    ...
    // Prefix and suffix are needed because they are used as expressions, i.e.
    // `#{University.prefix}`
