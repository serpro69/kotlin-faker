...
@Suppress("unused")
class Barcode internal constructor(fakerService: FakerService) :
    YamlFakeDataProvider<Barcode>(fakerService) {
    override val yamlCategory = YamlCategory.BARCODE
    ...
    fun compositeSymbol() =
        with(fakerService) { resolve("composite_symbol").numerify().letterify() }
