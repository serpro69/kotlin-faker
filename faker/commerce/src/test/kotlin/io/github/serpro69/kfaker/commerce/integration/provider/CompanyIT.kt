package io.github.serpro69.kfaker.commerce.integration.provider
...
class CompanyIT :
    DescribeSpec({
        describe("Company Provider") {
            val company: (locale: String) -> Company = {
                faker { fakerConfig { locale = it } }.company
            }
