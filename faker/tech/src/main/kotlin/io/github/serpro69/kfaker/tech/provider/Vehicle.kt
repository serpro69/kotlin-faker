...
@Suppress("unused")
class Vehicle internal constructor(fakerService: FakerService) :
    YamlFakeDataProvider<Vehicle>(fakerService) {
    ...
    @Deprecated(
        ...
        message = "Will be removed in 2.0, use 'manufacturer()' instead",
        replaceWith = ReplaceWith("manufacturer()"),
    )
    ...
    fun licencePlateByState(stateCode: String) =
        with(fakerService) {
