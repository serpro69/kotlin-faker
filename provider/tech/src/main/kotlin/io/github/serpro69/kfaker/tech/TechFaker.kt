 ...
 *
 * Each category (generator) from this [TechFaker] is represented by a property that has the same name as the `.yml` file.
 *
 * @property unique global provider for generation of unique values.
 */
@Suppress("unused")
class TechFaker @JvmOverloads constructor(config: FakerConfig = fakerConfig { }): AbstractFaker(config) {
...
/**
 * Applies the [block] function to [TechFaker.Builder]
 * and returns as an instance of [TechFaker] from that builder.
 */
